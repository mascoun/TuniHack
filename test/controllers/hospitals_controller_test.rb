...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { approved: @hospital.approved, name: @hospital.name, tel: @hospital.tel, web: @hospital.web } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { approved: @hospital.approved, name: @hospital.name, tel: @hospital.tel, web: @hospital.web } }
