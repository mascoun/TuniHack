...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post equipment_index_url, params: { equipment: { category: @equipment.category, hospital_id: @equipment.hospital_id, number: @equipment.number } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { category: @equipment.category, hospital_id: @equipment.hospital_id, number: @equipment.number } }
